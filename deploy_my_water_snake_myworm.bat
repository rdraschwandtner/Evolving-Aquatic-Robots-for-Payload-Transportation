...
echo cd water_snake_ode-%svnversionname%/Experiments/MyANN_Worm/ >> puttyrobonodes1commands.txt
...
echo cd water_snake_ode-%svnversionname%/Experiments/MyANN_Worm/ >> puttyrobonodes2commands.txt
...
echo cd water_snake_ode-%svnversionname%/Experiments/MyANN_Worm/ >> puttyrobonodes3commands.txt
