...
def evaluate_individual(individual):
    ...
    #simulation = Simulation(log_frames=False, run_num=99, eval_time=10.0, dt=.02, n=4, num_joints=9, aquatic=False)
    simulation = Simulation(log_frames=GlobalVarWorkaround.args.log_frames, run_num=GlobalVarWorkaround.args.run_num, eval_time=GlobalVarWorkaround.args.eval_time, dt=.02, n=4, num_joints=GlobalVarWorkaround.args.num_joints, aquatic=GlobalVarWorkaround.args.aquatic)
...
def initProcess(param):
   GlobalVarWorkaround.args = param
