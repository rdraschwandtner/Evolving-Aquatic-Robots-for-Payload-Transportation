...
pscp -sftp -pw InsertPassword temp_basic_locomotion-%svnversionname%.zip rened@robo10.cse.msu.edu:./workspace/


rem 5)
rem uncompress the file
echo cd workspace > puttyrobonodes10commands.txt
echo unzip temp_basic_locomotion-%svnversionname%.zip -d basic_locomotion-%svnversionname%/ >> puttyrobonodes10commands.txt
rem start the launchscript
echo cd basic_locomotion-%svnversionname%/Experiments/evolve_forward_swimming_after_grasp/ >> puttyrobonodes10commands.txt
rem make launch scripts executeable
echo chmod 755 ./launch_runs.sh >> puttyrobonodes10commands.txt
echo chmod 755 ./run_launcher.sh >> puttyrobonodes10commands.txt
echo chmod 755 ./validate_best.sh >> puttyrobonodes10commands.txt
echo chmod 755 ./evolutionary_progression_logging.sh >> puttyrobonodes10commands.txt
...
echo screen -dm sh -c './launch_runs.sh 0 17 %svnversionname%; exec bash' >> puttyrobonodes10commands.txt

rem 6)
putty -ssh rened@robo10.cse.msu.edu -pw InsertPassword -m puttyrobonodes10commands.txt
rem del puttyrobonodes1commands.txt
echo started launch script on robonodes 10
del puttyrobonodes10commands.txt
