...
def evaluate_individual(individual):
    ...
    GlobalVarWorkaround.foodenv = my_worm_simulation.FoodEnvironment(man=GlobalVarWorkaround.man,square_size=40,eucquadrant=random.choice([1,4]))
...
if __name__ == '__main__':
    ...
    parser.add_argument("--validatorquadrant", type=int, default=1, help="Specifies the euclidean quadrant that should be validated.")
    ...
    if GlobalVarWorkaround.args.validator:
        ...
        quad = GlobalVarWorkaround.args.validatorquadrant
        assert quad in range(1,5), 'Invalid Euclidean quadrant'

        my_worm_simulation.validator(NEAT_file, Morph_file, log_frames, run_num, eval_time, dt, n, numofjoints, output_path, gen, quad)
