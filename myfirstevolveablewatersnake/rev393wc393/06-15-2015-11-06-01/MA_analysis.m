...
overlapidcs = find(confmin<confmax2);
ciplot(confmin(overlapidcs),confmax2(overlapidcs),gens2(overlapidcs),overlapcolor);
%alpha(0.5);

le3 = plot(gens1([1:10:end end]),lower1([1:10:end end]),'r--','LineWidth',2);
le1 = plot(gens1([1:10:end end]), avg1([1:10:end end]),'kd-','MarkerFaceColor','k','LineWidth',2);

le6 = plot(gens2([1:10:end end]),lower2([1:10:end end]),'r-.','LineWidth',2);
le4 = plot(gens2([1:10:end end]), avg2([1:10:end end]),'ko-','MarkerFaceColor','k','LineWidth',2);

plot(gens1([1:10:end end]),upper1([1:10:end end]),'r--','LineWidth',2);
plot(gens2([1:10:end end]),upper2([1:10:end end]),'r-.','LineWidth',2)

breakxaxis([690 990],0.01);
