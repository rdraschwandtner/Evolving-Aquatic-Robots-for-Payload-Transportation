# Visualization module taken from Tony Clark
import json

# initial stop time and step size
TIME_STOP = 10
TIME_STEP = 10

# Magic number to upscale bodies in Tony's visualization
VIS_SCALE = 50

#
# Objects needed for Tony's visualization tool
#
...
def visualizationJSON_init (time_stop, time_step):
    ''' Initialize stop time and step size with given arguments.
    '''
    global json_object
    global TIME_STOP
    TIME_STOP = time_stop
