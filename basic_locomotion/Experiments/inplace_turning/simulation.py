...
class Simulation(object):
    ...
    def update_callback(self):
        ...
        for jointidx in range(int(self.worm._num_joints/2)):
            # phi value that is good enough for now - shall be optimized
            # 2*math.pi is just reasonable value - no connection to w
        ...
        #    phi = 2*math.pi/self.worm._num_joints-1 * (-jointidx)
