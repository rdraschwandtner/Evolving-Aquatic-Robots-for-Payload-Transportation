function jointanalysis21()
    ...
    hold on;
    title('joint value course');
    plot(stime,sjoint4angle,'r*');
    plot(stime,sejoint4angle,'r');
    plot(stime,sjoint12angle,'black*');
    plot(stime,sejoint12angle,'black');
    %legend('jointidx0','jointidx15')
    legend('act jointidx3','calc jointidx3','act jointidx11','calc jointidx11')
    grid on;
    hold off;
    ...
    hold on;
    title('joint value course');
    plot(stime,sjoint8angle,'yellow*');
    plot(stime,sejoint8angle,'yellow');
    plot(stime,sjoint9angle,'r*');
    plot(stime,sejoint9angle,'r');
    %legend('jointidx0','jointidx15')
    legend('act jointidx7','calc jointidx7','act jointidx8','calc jointidx8')
    grid on;
    hold off;
