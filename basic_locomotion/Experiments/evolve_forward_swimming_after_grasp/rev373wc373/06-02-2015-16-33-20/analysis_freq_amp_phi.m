...
function fname = exportfname(prefix, postfix)
    curdir = pwd;
    subdirs = textscan(curdir,'%s','Delimiter','\\');
    subdirsstr =  subdirs{1};
    fname = strcat(prefix, char(subdirsstr(end-2)), '_' ,char(subdirsstr(end-1)), postfix);
end