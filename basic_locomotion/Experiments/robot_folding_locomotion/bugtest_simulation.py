...
class Worm(object):
    ...
    def __create_robot(self):
        ...
        for counter in range(1,self._num_bodies-1):
            ...
            self.man.create_universal(j_num, con_point,[b_num-1,b_num],axis1=[0,0,-1],axis2=[0,1,0],loStop1=-y_joint_range,hiStop1=y_joint_range,loStop2=-joint_range,hiStop2=joint_range,fmax=MAXJOINT_FORCE[0],fmax2=MAXJOINT_FORCE[1])
            j_num += 1
            BODY_POS[0] -= SEG_DIMS[0]
...
class Simulation(object):
    ...
    def update_callback(self):
        ...
        #jointidx = 7
        #pos[jointidx] = convert_range(0, 360, -1, +1, +45)

        #for jointidx in range(7+1,self.worm._num_joints):
        #    cur_joint_angle = self.worm.get_joint_pos(jointidx)
        #    pos[jointidx] = 0 #cur_joint_angle
